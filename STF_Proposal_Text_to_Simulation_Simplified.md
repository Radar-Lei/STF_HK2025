...
Create a novel AI-powered system that integrates state-of-the-art Large Language Models with microscopic traffic simulation platforms such as SUMO, enabling natural language scenario generation that lowers the need for specialized simulation expertise and setup barriers required for diverse traffic simulation scenarios.
...
**Objective 4: Create a Simulation Foundation for Hong Kong's Smart Mobility**
Establish a scalable simulation architecture that mirrors Hong Kong’s complex network, supporting real-time simulation and predictive analysis across congestion, travel times, and environmental impacts while integrating seamlessly with existing ITS infrastructure.
